...
import time
from pyfiglet import Figlet # pip install pyfiglet and comment this line for no ASCII art
import requests
...
f = Figlet(font='slant') # Comment this line for no ASCII art
print(f.renderText('Scraping started!')) # Comment this line for no ASCII art
